 ...
 * 
 *          and lists the total average charge for each procedure.
 * 
 */
...
public class InPatient {
	...
	public static class InPatientMap extends MapReduceBase implements
	...
	public static class InPatientReduce extends MapReduceBase implements
	...
	public static void main(String[] args) throws Exception {
		...
		// purposes
		JobConf conf = new JobConf(InPatient.class);
		...
		conf.setMapperClass(InPatientMap.class);
		conf.setReducerClass(InPatientReduce.class);
